...
public class PieceMovesCalculator2 {
    private List<ChessMove> possibleMovesList = new ArrayList<>();
    private ChessBoard board;
    private ChessPosition position;
    private ChessPiece piece;

    public PieceMovesCalculator2(ChessBoard board, ChessPosition position) {
        this.board = board;
